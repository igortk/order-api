...
**Order-API** is an interface that allows users to interact with the stock exchange system.  
All available functionalities are described below.
...
**Request:** `GET /v1/currency/exchange/rate`  
```json
{
...
**Request:** `GET /v1/user/balance/emit`  
```json
{
  "id": "123-balance-emit",
  "user_id": "123-user_id",
...
**Request:** `GET /v1/user/balance/info/{user_id}`  
**Response:**  
```json
{
